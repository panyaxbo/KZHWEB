...
'<table style="background-color:#fff">'+
	'<tbody>'+
		'<tr>'+
			...
			'<h2 style="font:normal"><img height="20" src="cid:letter@kzh.parts.co.th" style="margin-right:10px" width="21" >&nbsp;&nbsp;Email Confirm Activation </h2>'+
...
'</td> </tr>'+
		...
		'</tbody></table>',
		  attachments: [
			...
			{
				fileName : 'letter.png',
				filePath : appRoot + '/service/mail/letter.png',
				cid: 'letter@kzh.parts.co.th'
			}
			]
		}
